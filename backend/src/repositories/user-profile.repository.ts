...
export function createUserProfile(userId: number, data: CreateUserProfileInput) {
...
export function updateUserProfileById(id: number, data: UpdateUserProfileInput) {
